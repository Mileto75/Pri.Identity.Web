...
namespace Pri.Api.Music.Infrastructure.Migrations
{
    public partial class ChangeKeyType : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Records",
                columns: new[] { "Id", "ArtistId", "Created", "GenreId", "Image", "Price", "Title", "Updated" },
                values: new object[] { 1, 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, null, 99.00m, "Live in Lapscheure", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "Records",
                columns: new[] { "Id", "ArtistId", "Created", "GenreId", "Image", "Price", "Title", "Updated" },
                values: new object[] { 2, 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, null, 9.00m, "Think about the children", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "Records",
                columns: new[] { "Id", "ArtistId", "Created", "GenreId", "Image", "Price", "Title", "Updated" },
                values: new object[] { 3, 3, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, null, 299.00m, "Ten", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });
